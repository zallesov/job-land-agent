...
Usage:
  ...
  python3 scripts/enrich_jobs_batch.py --job-ids 42 43 44
  python3 scripts/enrich_jobs_batch.py --db jobs.db --cdp-url http://localhost:9222 --job-ids 42,43
"""
...
def main() -> int:
    ...
    ok_ids, failures = enrich_jobs_batch(job_ids, db_path=args.db, cdp_url=args.cdp_url, max_workers=args.workers)
