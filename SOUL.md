...
- Never use a developer checkout path such as `/Users/zall/interviews` from an installed profile. Installed and development profiles must keep independent `jobs.db`, `config/`, `dashboard/`, `scripts/`, and `skills/` state.
